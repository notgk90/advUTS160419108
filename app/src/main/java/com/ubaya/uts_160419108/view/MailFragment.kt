...
class MailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recView.adapter = mailListAdapter
    }

    fun observeViewModel(){
        viewModel.mailLD.observe(viewLifecycleOwner, Observer {
            mailListAdapter.updateMailList(it)
        })
    }
}